...
//secured routes
//DO NOT MAKE THE LOGOUT ROUTE AS PROTECTED
router.route("/logout").post(verifyJWT,logoutUser)
// IN THE FRONT END FISRT VERIFY THE ACCESS TOKEN. IF THE ACCESS TOKEN IS INVALID THAN USE THIS TO REFRESH THE ACCESS TOKEN. IF IT IS NOT ABLE TO VERIFY THE REFRESH TOKEN THAN FORCE LOGOUT
